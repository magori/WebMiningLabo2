...
\\
Notre premier constat est le temps nécessaire à calculer les règles d'associations des produits \textit{par clients}. En effet, a contrario le résultat pour \textit{par facture} est quasi instantané. Notre hypothèse pour expliquer cette différence de temps est \todo{WTY IS IT SO LONG}.
Notre deuxième constatation est: \todo{WHAT IS IT?}
